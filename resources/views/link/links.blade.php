...
<body class="w-full min-h-screen bg-slate-50 flex flex-col">
    ...
    <main class="w-full flex flex-col gap-8 p-[5%]">
        ...
        <div class="flex items-center justify-between">
            ...
            <button class="bg-[#0F172A] text-white px-5 py-2.5 rounded-xl font-bold text-sm hover:bg-slate-800 transition-all shadow-sm">
                + Ajouter un lien
            </button>
        </div>
        ...
        <div class="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-7">
            ...
            <div class="group relative bg-white border border-gray-200 shadow-sm rounded-2xl p-5 hover:shadow-md transition-all cursor-pointer">
                <div class="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button class="p-1.5 bg-slate-50 hover:bg-blue-50 text-slate-400 hover:text-blue-600 rounded-lg border border-gray-100 transition-colors">
                    ...
                    <button class="p-1.5 bg-slate-50 hover:bg-red-50 text-slate-400 hover:text-red-600 rounded-lg border border-gray-100 transition-colors">
                ...
                <div class="space-y-1">
                    <h3 class="text-lg font-bold text-[#0F172A] tracking-tight truncate">Google Search</h3>
                    <p class="text-[14px] font-medium text-slate-500 truncate">https://www.google.com</p>
                </div>

                <a href="#" class="mt-4 flex items-center text-[#1B294B] font-bold text-xs hover:gap-2 transition-all">
            ...
            <div class="group relative bg-white border border-gray-200 shadow-sm rounded-2xl p-5 hover:shadow-md transition-all cursor-pointer">
                <div class="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button class="p-1.5 bg-slate-50 rounded-lg border border-gray-100 transition-colors"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg></button>
                ...
                <div class="space-y-1">
                    <h3 class="text-lg font-bold text-[#0F172A] tracking-tight truncate">GitHub Profile</h3>
                    <p class="text-[14px] font-medium text-slate-500 truncate">https://github.com/username</p>
                </div>
                <a href="#" class="mt-4 flex items-center text-[#1B294B] font-bold text-xs hover:gap-2 transition-all">
                    Visiter le lien <span class="ml-1">→</span>
                </a>
            ...
            <div class="w-full h-full border-2 border-dashed border-gray-200 rounded-2xl flex flex-col items-center justify-center p-6 hover:border-[#1B294B] hover:bg-slate-50 transition-all cursor-pointer group">
