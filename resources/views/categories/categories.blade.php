    ...
    <main class="w-full flex flex-col gap-8 p-[5%]">
        ...
        <div class="w-full grid grid-cols-4 gap-7">
            ...
            <div class="group bg-white border border-gray-200 shadow-sm rounded-2xl p-6 hover:shadow-md hover:border-[#F59F0A] transition-all cursor-pointer">
                ...
                <div class="space-y-1">
                    <h3 class="text-xl font-bold text-[#0F172A]">Développement Web</h3>
                    <p class="text-sm font-medium text-slate-500">12 Liens enregistrés</p>
                </div>
            ...
            <div class="group bg-white border border-gray-200 shadow-sm rounded-2xl p-6 hover:shadow-md hover:border-[#F59F0A] transition-all cursor-pointer">
                ...
                <div class="space-y-1">
                    <h3 class="text-xl font-bold text-[#0F172A]">Design Resources</h3>
                    <p class="text-sm font-medium text-slate-500">8 Liens enregistrés</p>
                </div>
                <div class="mt-4 flex items-center text-[#F59F0A] font-bold text-sm group-hover:gap-2 transition-all">
                    Voir les liens <span class="ml-1">→</span>
                </div>
            ...
            <div class="group bg-white border border-gray-200 shadow-sm rounded-2xl p-6 hover:shadow-md hover:border-[#F59F0A] transition-all cursor-pointer">
                ...
                <div class="space-y-1">
                    <h3 class="text-xl font-bold text-[#0F172A]">Marketing</h3>
                    <p class="text-sm font-medium text-slate-500">5 Liens enregistrés</p>
                </div>
                <div class="mt-4 flex items-center text-[#F59F0A] font-bold text-sm group-hover:gap-2 transition-all">
                    Voir les liens <span class="ml-1">→</span>
                </div>
